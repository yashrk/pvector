...
Reads from random index, average time in second (lesser is better), with various element count. Performance of persistent vector, scheme arrays (SRFI-43), vlists (linked lists are unacceptable slow with element count involved). Logarithmic scale on data size axis.
